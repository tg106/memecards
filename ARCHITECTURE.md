...
|  Event.java               |              +--------------------------------+                             |   |                        +-----------------------+   |                           +------------------+
|  Deck.java                |       +----->+  CardInformationActivity.java  +<---------------------+      |   |                                                |   |    +--------------------->+  AI_Player.java  |
|  MemeCard.java            |       |      +--------------------------------+                      |      |   |                                                |   |    |                      +------------------+
|  EventList.java           |       |                                                              |      |   +--------------------------------------------+   |   |    |
|                           |       |          +----------------------------+                      |      |                                                |   |   |    |                      +-------------------+
+---------------------------+       |          |  RecyclerViewAdapter.java  +<---------------------+      |                                                |   |   |    +--------------------->+  GameEngine.java  |
                                    |          +----------------+-----------+                      |      |                                                |   |   |    |                      +-------------------+
  +----------------------+          |                           ^                                  |      v                                                v   v   v    |
  |                      |          |                           |                   +--------------+------+------+        +---------------------+         ++---+---+----+------------+      +--------------------------+
  |    Business Layer    |          |                           |                   |  CardLibraryActivity.java  +<-------+  MainActivity.java  +-------->+  StartGameActivity.java  +----->+  PopupCardActivity.java  |
  |                      |          |                           |                   +--------------+-------------+        +---------+-----------+         +-------------+------------+      +-------------+------------+
  +----------------------+          |                           |                                  ^                                ^                                   ^                                 ^
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
                                    |                           |                                  |                                |                                   |                                 |
