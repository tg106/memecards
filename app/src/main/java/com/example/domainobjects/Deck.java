...
public class Deck {
    ...
    public void generatingTestDeckforAI() {
        ...
        deck.add(new MemeCard("Gachi","Manliest man on earth, SPAM GachiBASS for ANIKI", "card_img_gachi",2000,"IRL", false));
        deck.add(new MemeCard("Thanos","The most powerfull creature on the universe", "card_img_thanos",5000,"Movies", false));
        deck.add(new MemeCard("Tom Cat","God father of cartoon", "card_img_tomcat",2000,"Cartoon", false));
        deck.add(new MemeCard("Pepe Frog","PepeHands ...", "card_img_pepe",1000,"IRL", false));
    }
